    ...
    async function fetchMovie() {
      try {
        const response = await axios.get(
          `http://localhost:1337/api/schedule/${movieId}`
        );
        ...
        <>
          <div className="container" style={{ width: "80%", margin: "auto" }}>
            ...
            <div
              ...
              style={{ marginLeft: "32%", marginTop: "-45px" }}
            >
              <p
                style={{
                  marginBottom: "0em",
              ...
              {movie.airing_time && movie.airing_time.length > 0 && (
                ...
                >
                  {`${new Date(
                    movie.airing_time[0].start_time
              ...
              <div>
                {movie.airing_time &&
                  movie.airing_time
                    ...
                    ) // Sort the array based on start_time
                    .map((time, index) => (
                      <Link
                        to={`/seat/${movie._id}/${time._id}`}
                        key={index}
